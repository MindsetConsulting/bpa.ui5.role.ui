		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BPA Role Assignment Form",
									"targetURL": "#bparoleassignmentuiworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bparoleassignmentuiworkflowuimodule-display": {
								"semanticObject": "bparoleassignmentuiworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bparoleassignmentui.workflowuimodule",
									"url": sap.ui.require.toUrl("bparoleassignmentui/workflowuimodule")
								}
							}
						}
					}
